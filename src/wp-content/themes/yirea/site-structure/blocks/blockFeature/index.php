...
<section id="services" class="section">
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-md-6 col-sm-12">
                <div class="item-boxes services-item wow fadeInDown animated" data-wow-delay="0.4s"
            ...
            <div class="col-lg-4 col-md-6 col-sm-12">
                <div class="item-boxes services-item wow fadeInDown animated" data-wow-delay="0.6s"
            ...
            <div class="col-lg-4 col-md-6 col-sm-12">
                <div class="item-boxes services-item wow fadeInDown animated" data-wow-delay="0.8s"
            ...
            <div class="col-lg-4 col-md-6 col-sm-12">
                <div class="item-boxes services-item wow fadeInDown animated" data-wow-delay="1s"
            ...
            <div class="col-lg-4 col-md-6 col-sm-12">
                <div class="item-boxes services-item wow fadeInDown animated" data-wow-delay="1.2s"
        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-md-6 col-sm-12">
                <div class="featured-box">
                    ...
                    <div class="featured-content">
                        <div class="icon-o"><i class="lni lni-layout"></i></div>
            ...
            <div class="col-lg-4 col-md-6 col-sm-12">
                <div class="featured-box">
                    ...
                    <div class="featured-content">
                        <div class="icon-o"><i class="lni lni-tab"></i></div>
            ...
            <div class="col-lg-4 col-md-6 col-sm-12">
                <div class="featured-box">
                    ...
                    <div class="featured-content">
                        <div class="icon-o"><i class="lni lni-database"></i></div>
                        <h4>SEO Optimized</h4>
                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut
                            labore et magna aliqua.</p>
                    </div>
            ...
            <div class="col-lg-4 col-md-6 col-sm-12">
                <div class="featured-box">
                    ...
                    <div class="featured-content">
                        <div class="icon-o"><i class="lni lni-leaf"></i></div>
                        <h4>Clean Code</h4>
                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut
                            labore et magna aliqua.</p>
                    </div>
                    ...
                    <div class="team-details">
                        <div class="team-inner">
                            ...
                            <ul class="social-list">
                                <li class="facebook"><a href="#"><i class="lni lni-facebook-filled"></i></a></li>
                                <li class="twitter"><a href="#"><i class="lni lni-twitter-filled"></i></a></li>
                                <li class="google-plus"><a href="#"><i class="lni lni-instagram"></i></a></li>
                                <li class="linkedin"><a href="#"><i class="lni lni-linkedin-original"></i></a></li>
                            </ul>
                        </div>
                    </div>
                </div>
...
<section id="blog" class="section">
    ...
    <div class="container">
        ...
        <div class="row justify-content-md-start justify-content-center">
            <div class="col-lg-4 col-md-6 col-sm-10 blog-item">
                ...
                <div class="blog-item-wrapper">
                    ...
                    <div class="blog-item-text">
                        <div class="date"><i class="lni lni-calendar"></i>10 April, 2023</div>
